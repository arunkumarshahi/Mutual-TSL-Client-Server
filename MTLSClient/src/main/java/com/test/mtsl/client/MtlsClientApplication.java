...
//			keyStore.load(inputStream, "clientpassword".toCharArray());
//
//			SSLConnectionSocketFactory socketFactory =
//					new SSLConnectionSocketFactory(new SSLContextBuilder()
//					.loadTrustMaterial(null, new TrustSelfSignedStrategy())
//					.loadKeyMaterial(keyStore, "clientpassword".toCharArray()).build(),
...
public class MtlsClientApplication {
	...
	public static void main(String[] args) {
		 //SpringApplication application = new SpringApplication(MtlsClientApplication.class);
